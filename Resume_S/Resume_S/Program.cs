...
namespace ResumeEmployerExtractor
{
    public class EmployerExtractor
    {
        ...
        {
            string inputDirectory = @"C:\All Resumes"; // Directory containing PDF resumes
            string outputPath = @"C:\Users\Pooja S\Desktop\EmployerDetails4.xlsx";
